...
public class RegistroHorasController {
    ...
    @PreAuthorize("hasRole('ADMIN') or (hasRole('MECANICO') " +
            "and @tallerAuthorization.esMecanicoPropietario(authentication, #req.mecanicoId) " +
            "and @tallerAuthorization.esOrdenAsignadaAlMecanico(authentication, #req.ordenId))")
    ...
    @PreAuthorize("hasRole('ADMIN') or (hasRole('MECANICO') " +
            "and @tallerAuthorization.esOrdenAsignadaAlMecanico(authentication, #ordenId))")
